...
foreach(BUILD_TYPE IN LISTS BUILD_TYPES)
    ...
    vcpkg_apply_patches(
        ...
        ${CMAKE_CURRENT_LIST_DIR}/0002-Fix-spatialite-include.patch
		${CMAKE_CURRENT_LIST_DIR}/0003-Fix-cpl_string-isspace.patch
		${CMAKE_CURRENT_LIST_DIR}/0004-Fix-cpl_string-isdigit.patch
    )
endforeach()
...
# Setup freexl libraries + include path
file(TO_NATIVE_PATH "${CURRENT_INSTALLED_DIR}/include" FREEXL_INCLUDE_DIR)
...
# Setup netcdf-c libraries + include path
...
list(APPEND NMAKE_OPTIONS
    ...
    FREEXL_CFLAGS=-I${FREEXL_INCLUDE_DIR}
    # NETCDF_PLUGIN=NO
    # NETCDF_SETTING=yes
...
list(APPEND NMAKE_OPTIONS_REL
    ...
    FREEXL_LIBS=${FREEXL_LIBRARY_REL}
    # NETCDF_LIB=${NETCDF_LIBRARY_REL}
)
...
list(APPEND NMAKE_OPTIONS_DBG
    ...
    FREEXL_LIBS=${FREEXL_LIBRARY_DBG}
    # NETCDF_LIB=${NETCDF_LIBRARY_DBG}
    DEBUG=1
)
